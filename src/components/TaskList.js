...
export const TaskList = props => {
  ...
  const [tasks, setTask] = useState([
    ...
    { id: uuidv4(), project: 'Node/Express', taskdesc: 'E and N of MERN', time: 0, startdt: '', lastmodified: '', active: false },
    { id: uuidv4(), project: 'Mongo', taskdesc: 'M of MERN', time: 0, startdt: '', lastmodified: '', active: true }
  ])
